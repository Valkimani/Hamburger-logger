...
In this assignment, to create a burger logger with MySQL, Node, Express, Handlebars and a homemade ORM. MVC design pattern; Node and MySQL to query and route data have been applied in the app, and Handlebars to generate the HTML. The app has been deployed on Heroku.
